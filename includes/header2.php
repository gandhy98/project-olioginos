...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../css1/bootstrap-icons.css">    
    ...
    <link rel="stylesheet" href="../css1/estiloindex.css">
  ...
  <nav class="navbar navbar-light fixed-top color_menu" style="padding: 0px">
    ...
    <ul>      
      ...
      <li>
        ...
        <li id='mnu_lina_mk'><hr></li>                               
          <li id='mnu_cotizaciones'><a href="../Form/cotizaciones.php"> <h5 class="color_letra_menu tamano_font"><i class="bi bi-filetype-doc"></i> COTIZACIONES</h5></a></li>                    
          <li id='mnu_ordenes'><a href="../Form/locales.php"> <h5 class="color_letra_menu tamano_font"><i class="bi bi-file-earmark-post-fill"></i> ORDENES DE COMPRA</h5></a></li>
          <li id='mnu_registro'><a href="../Form/locales.php"> <h5 class="color_letra_menu tamano_font"><i class="bi bi-file-post"></i> REGISTRO DE COMPRAS</h5></a></li>
      ...
      <li>
        <a href="#" id='mnu_produccion' class="feat-btn"><h5 class="color_letra_menu"><i class="bi bi-boxes"></i><b class="tamano_font"> PRODUCCION Y VENTAS</b> 
        <span id="flecha_1" class="bi bi-caret-down-fill first"></span>
        </h5></a>
        <ul class="feat-show" id="mnu_produccion_sub"> 
        <li id='mnu_lina_mk'><hr></li>                                         
          <li id='mnu_control_produccion'><a href="../Form/Mis_prospectos.php"> <h5 class="color_letra_menu tamano_font"><i class="bi bi-ui-checks-grid"></i> CONTROL PRODUCCION</h5></a></li>                                         
          <li id='mnu_prospeccion'><a href=""> <h5 class="color_letra_menu tamano_font"><i class="bi bi-cash-coin"></i> FACTURACION Y VENTAS</h5></a></li>                                         
          <li id='mnu_prospeccion'><a href=""> <h5 class="color_letra_menu tamano_font"><i class="bi bi-calendar-date-fill"></i> PROGRAM. DE DESPACHOS</h5></a></li>                            
      ...
      <li><hr></li>  
       ...
       <li>
        <a href="#" id='mnu_mantenimiento' class="feat-btn"><h5 class="color_letra_menu"><i class="fa-solid fa-gears"></i> <b class="tamano_font">CONFIGURACION</b>
        ...
        <li id="mnu_manto_1"><a href="../Form/almacenes.php"> <h5 class="color_letra_menu tamano_font"><i class="bi bi-buildings-fill"></i> EMPRESAS</h5></a></li>
          ...
          <li id="mnu_manto_7"><a href="../Form/usuarios_listado.php"> <h5 class="color_letra_menu tamano_font"><i class="bi bi-people-fill"></i> USUARIOS </h5></a></li>         
          <li id="mnu_manto_8"><hr></li>          
        </ul>        
      </li>

      
      <li><a href="../Form/Salir.php"><h5 class="color_letra_menu"><i class="bi bi-door-closed-fill"></i> <b class="tamano_font">SALIR</b></h5></a></li>
